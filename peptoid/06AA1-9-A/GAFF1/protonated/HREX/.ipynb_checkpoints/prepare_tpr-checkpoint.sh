...
do
  ...
  cp ../06AA1-9-A_fep.gro .
  cp ../06AA1-9-A_fep.top .
  cp ../06AA1-9-A_fep.itp .
  cp ../prod_fep.mdp .
  cp ../index.ndx .  
  cp ../acetonitrile_320_box.itp .

  # Check if files exist
  if [ ! -f "06AA1-9-A_fep.gro" ] || [ ! -f "06AA1-9-A_fep.top" ] || [ ! -f "prod_fep.mdp" ]|| [ ! -f "index.ndx" ]|| [ ! -f "acetonitrile_320_box.itp" ]; then
  ...
  gmx grompp -f prod_fep.mdp -c 06AA1-9-A_fep.gro -p 06AA1-9-A_fep.top -n index.ndx -o HREMD.tpr -maxwarn 4
